...
- **Outlier Analysis**: Identified 1,239 potential outliers using the 1.5*IQR rule. Made the analytical decision not to remove them, as these samples represent real-world (very good or very bad) wines. The final models are trained on the complete dataset to ensure they are robust and can handle real-world variance.
...
- **Result:** Moderate performance with R² of **0.270** and accuracy of **54.5%** within ±0.5 rating tolerance.
...
- **Result:** Higher accuracy of **57.7%** and R² of **0.384**, outperforming the Elastic Net model.
